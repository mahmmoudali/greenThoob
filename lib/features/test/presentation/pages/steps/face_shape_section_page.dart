...
class FaceShapeSectionPage extends StatefulWidget {
  ...
  @override
  _FaceShapeSectionPageState createState() => _FaceShapeSectionPageState();
}

class _FaceShapeSectionPageState extends State<FaceShapeSectionPage> {
  bool? _isSelected;
  int? _styleSelected;
                ...
                Container(
                  ...
                  child: Text(
                    Translations.of(context)
                        .translate('select_the_shape_of_the face'),
                    style: textStyle.middleTSBasic.copyWith(
                        color: globalColor.black, fontWeight: FontWeight.w600),
                  ),
                ),
                Expanded(
                  child: FaceShapeSelectWidget(
                ...
                onPressed: _styleSelected == null
                    ...
                    : () {
                        if (widget.onSelect != null) {
                          widget.onSelect(
                              4,
                              'select_the_shape_of_the_frame_and_lenses',
                              _styleSelected!);
