...
class StyleGlassesSelectWidget extends StatefulWidget {
  final Function(int) onSelected;
  final double width;
  final double height;
  final List<ExtraGlassesItemEntity> items;

  const StyleGlassesSelectWidget(
      {required this.height,
      required this.width,
      required this.onSelected,
      required this.items});
  @override
  _StyleGlassesSelectWidgetState createState() =>
      _StyleGlassesSelectWidgetState();
}

class _StyleGlassesSelectWidgetState extends State<StyleGlassesSelectWidget> {
