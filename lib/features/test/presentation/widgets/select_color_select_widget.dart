...
class SelectColorSelectWidget extends StatefulWidget {
  final Function(int) onSelected;
  final double width;
  final double height;
  final List<ExtraGlassesItemEntity> items;

  const SelectColorSelectWidget(
      {required this.height,
      required this.width,
      required this.onSelected,
      required this.items});
  @override
  _SelectColorSelectWidgetState createState() =>
      _SelectColorSelectWidgetState();
}

class _SelectColorSelectWidgetState extends State<SelectColorSelectWidget> {
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Container(
                        ...
                        height: 35,
                        decoration: BoxDecoration(
                            color: HexColor(value), shape: BoxShape.circle),
