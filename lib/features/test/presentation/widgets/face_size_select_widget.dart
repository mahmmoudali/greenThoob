...
class FaceSizeSelectWidget extends StatefulWidget {
  final Function(int) onSelected;
  final double width;
  final double height;
  final List<ExtraGlassesItemEntity> items;

  const FaceSizeSelectWidget(
      {required this.height,
      required this.width,
      required this.onSelected,
      required this.items});
  @override
  _FaceSizeSelectWidgetState createState() => _FaceSizeSelectWidgetState();
}

class _FaceSizeSelectWidgetState extends State<FaceSizeSelectWidget> {
