...
class FaceShapeSelectWidget extends StatefulWidget {
  final Function(int) onSelected;
  final double width;
  final double height;
  final List<ExtraGlassesItemEntity> items;

  const FaceShapeSelectWidget(
      {required this.height,
      required this.width,
      required this.onSelected,
      required this.items});
  @override
  _FaceShapeSelectWidgetState createState() => _FaceShapeSelectWidgetState();
}

class _FaceShapeSelectWidgetState extends State<FaceShapeSelectWidget> {
        ...
        ? Container(
            ...
            child: GridView.builder(
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                  ...
                  crossAxisSpacing: 1,
                  mainAxisSpacing: 4,
                  childAspectRatio: widget.width * .31 / 149.h,
                ),
