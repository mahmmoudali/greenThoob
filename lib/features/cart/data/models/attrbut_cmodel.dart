...
Attrbuotmodel attrbuotmodelFromJson(String str) =>
    Attrbuotmodel.fromJson(json.decode(str));
...
class Result {
  ...
  factory Result.fromJson(Map<String, dynamic> json) => Result(
        quantitylist: List<Deliveryto>.from(
            json["quantitylist"].map((x) => Deliveryto.fromJson(x))),
        deliveryto: List<Deliveryto>.from(
            json["deliveryto"].map((x) => Deliveryto.fromJson(x))),
        loadproduct: List<Deliveryto>.from(
            json["loadproduct"].map((x) => Deliveryto.fromJson(x))),
        desttype: List<Deliveryto>.from(
            json["desttype"].map((x) => Deliveryto.fromJson(x))),
      );
