...
//                                   height: height,
//                                   listOfColor:
//                                   args.product.colorInfo ?? []),
//
//                               _buildEnterDimensionsTitleWidget(context: context,
//                                   width: width, height: height
//                               ),
...
//                     ),
//                     _buildButtonsWidget(
//                       context: context, widthC: width, height: height,
//                     ),
//                   ],
//                 ),
//               )
...
//               child: Container(
//                 child: Text(
//                   Translations.of(context).translate('attach_the_size_of_the_lenses'),
//                   style: textStyle.smallTSBasic.copyWith(
//                       fontWeight: FontWeight.w500, color: globalColor.black),
//                 ),
//               ),
...
//     return _selectedForAddIPD!=null && _selectedForLeftEye!=null && _selectedForRightEye!=null &&companyLenses!=null &&_colorSelect!=null&&_chooseType!=null;
//   }
// }
//
//
