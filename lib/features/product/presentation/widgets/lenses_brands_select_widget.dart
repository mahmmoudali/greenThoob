...
//
//   const BrandsLensesSelectWidget({@required this.height,@required this.width,@required this.onSelected,@required this.items});
//   @override
...
//
//
//   BrandEntity selectedStyle =BrandEntity(id: -11121, name: 'null', image: 'null');
...
//   }
//
//   _buildItem({String title,bool isSelected,String image,double width,double height,BuildContext context,BrandEntity selected}){
//     return Container(
...
//                             Container(
//                               decoration: BoxDecoration(
//                                   color: isSelected ? globalColor
//                                       .primaryColor : globalColor.transparent,
//                                   borderRadius:
...
//                                 globalColor.goldColor: globalColor.grey.withOpacity(0.3),
//                               ),
//                             ),
//                             SizedBox(
//                               width: 5.h,
