...
//
//   const LensSelectSizeWidget({this.height,this.width,@required this.onSelected,this.defaultValue});
//   @override
...
//
//
//           HorizontalPadding(percentage: 1.0,),
//
//           Expanded(
//             child:  _buildItem(
//                 context: context,
...
//   }
//
//   _buildItem({String title,bool isSelected,double width,double height,BuildContext context,LensesSelectedEnum selected}){
//     return InkWell(
//       onTap: (){
//         if(mounted)
//           setState(() {
...
//                 Container(
//                   height: 15.h,
//                   child: Icon(MaterialIcons.keyboard_arrow_down,size: 15.h,),
...
//                     border: Border.all(
//                         color: isSelected ? globalColor.primaryColor : globalColor.grey.withOpacity(0.3),
//                         width: 0.5
//                     )
//                 ),
