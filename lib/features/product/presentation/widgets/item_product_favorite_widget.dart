...
class ItemProductFavoriteWidget extends StatefulWidget {
  final ProductEntity product;
  final double width;
  final double height;
  const ItemProductFavoriteWidget(
      {required this.product, required this.width, required this.height});
  @override
  _ItemProductFavoriteWidgetState createState() =>
      _ItemProductFavoriteWidgetState();
}

class _ItemProductFavoriteWidgetState extends State<ItemProductFavoriteWidget> {
  @override
