...
class TermsCondetion extends StatefulWidget {
  static const routeName = '/others/sub_pages/pages/TermsCondetion';

  @override
  _TermsCondetionState createState() => _TermsCondetionState();
}

class _TermsCondetionState extends State<TermsCondetion> {
  @override
  void initState() {
    super.initState();
  }
