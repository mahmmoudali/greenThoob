...
class BasicInfoPage extends StatefulWidget {
  ...
  const BasicInfoPage({required this.width, required this.height});
    ...
    return BlocListener<ProfileBloc, ProfileState>(
      ...
      listener: (BuildContext context, state) async {
        if (state is ProfileDoneState) {
          ...
          _phone = state.profile!.phone ?? '';
          cityEditingController!.text = state.profile!.address ?? '';
          _city = state.profile!.address ?? '';
          messageEditingController!.text = state.profile!.about_me ?? '';
          _message = state.profile!.about_me ?? '';
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: NormalOjosTextFieldWidget(
                            ...
                            hintText: '',
                            label:
                                Translations.of(context).translate('address'),
                            keyboardType: TextInputType.text,
                            borderRadius: widget.width * .02,
                            // prefixIcon: Container(
                            //   width: 15.w,
