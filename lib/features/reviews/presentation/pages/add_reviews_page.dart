                        ...
                        child: Column(
                          children: [
                            _buildTopWidget(
                                ...
                                width: width,
                                height: height,
                                discountPrice: args.discount_price!.toDouble(),
                                    ...
                                    child: Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              '${appConfig.notNullOrEmpty(args.rate!.toString()) ? args.rate : '-'}',
                                            ...
                                            Text(
                                              '${Translations.of(context).translate('average')}  ${Translations.of(context).translate('reviews')}',
