...
import 'package:ojos_app/features/order/presentation/widgets/basic_order_online.dart';
...
class _OnlineOrderState extends State<OnlineOrder>
  ...
  Widget build(BuildContext context) {
    ...
    AppBar appBar = AppBar(
      ...
      //                           right: EdgeMargin.sub, left: EdgeMargin.sub),
      //                       decoration: BoxDecoration(
        ...
        ? DefaultTabController(
            ...
            child: Scaffold(
              ...
              body: Container(
                ...
                height: height,
                key: _listKey,
                child: BasicOrderListPageOnline(
                  height: height,
                  width: width,
                  filterParams: {
                    'order_status': 'new',
