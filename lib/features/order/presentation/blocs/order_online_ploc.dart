...
class OrderBlocOnline extends Bloc<OrderEvent, OrderState> {
  OrderBlocOnline() : super(OrderUninitializedState());
  ...
  Stream<OrderState> mapEventToState(OrderEvent event) async* {
    if (event is GetOrderEvent) {
      ...
      final result = await GetOrdersOnline(locator<OrderRepository>())(
        GetOrdersParams(
