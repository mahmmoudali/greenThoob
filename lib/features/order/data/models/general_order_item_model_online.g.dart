...
part of 'general_order_item_model_online.dart';
// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

// import 'city_order_model.dart';

GeneralOrderItemModel1 _$GeneralOrderItemModel1FromJson(
    Map<String, dynamic> json) {
  return GeneralOrderItemModel1(
    id: json['id'] as int,
    ...
    order_items: json['order_items'] != null
        ? json['order_items']!.map((t) => t.toEntity()).toList()
        : [],
    ...
    user_address: json['user_address'] =
        UserAddressModel.fromJson(json['user_address'] as Map<String, dynamic>),
  );
}

Map<String, dynamic> _$GeneralOrderItemModel1ToJson(
        GeneralOrderItemModel1 instance) =>
    <String, dynamic>{
      'id': instance.id,
      'uuid': instance.uid,
